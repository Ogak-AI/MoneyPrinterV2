...
def get_password_hash(password: str) -> str:
    ...
    # We encode and handle truncation if needed (though bcrypt usually handles it by ignoring extra bytes)
    # Most modern implementations truncate to 72 for compatibility
